...
# The Original Script with issues
...
# print() needs to be on a new line too
# Output is 'You need to buy I need to buy 60 nails nails'
# print() Should just be calling the message
# I have updated the message too
